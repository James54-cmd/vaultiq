  ...
  <>
    ...
    >
      <DialogContent
        ...
        className="flex max-h-[90vh] w-[92vw] max-w-3xl flex-col gap-0 rounded-2xl p-0 max-[480px]:w-full max-[480px]:max-w-[calc(100vw-32px)] max-[480px]:rounded-xl"
      >
        {/* Header */}
        <div className="shrink-0 border-b px-6 py-4 max-[480px]:px-4 max-[480px]:py-3">
          <DialogTitle className="text-base py-2 font-semibold text-foreground">
            Edit Transaction Labels
          </DialogTitle>
          <DialogDescription className="text-sm pb-4 text-muted">
            You can adjust merchant, category, and notes without changing the underlying ledger facts.
          </DialogDescription>
        </div>
        ...
        >
          <div
            ref={scrollBodyRef}
            className="scrollbar-hide flex-1 overflow-y-auto px-6 py-5 max-[480px]:px-4 max-[480px]:py-4"
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-medium text-foreground">Verified Transaction Fields</p>
                  <p className="mt-0.5 text-xs text-muted">
                    These values stay disabled so the record remains traceable to the original entry.
                  </p>
                </div>
                <hr />
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-medium text-foreground">Editable Labels</p>
                  <p className="mt-0.5 text-xs text-muted">
                    These are the only fields that can be refined after a transaction has been recorded.
                  </p>
                </div>
                <hr />
          ...
          {/* Footer */}
          <div className="shrink-0 border-t px-6 py-4 max-[480px]:px-4 max-[480px]:py-3">
            <div className="flex w-full flex-col gap-3 py-4 sm:flex-row sm:justify-end">
